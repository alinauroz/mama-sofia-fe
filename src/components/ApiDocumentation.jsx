...
<div loading="lazy" className = "container-fluid login-section nopadding-container">
    ...
    <h1>GET - all Recipes</h1>
        ...
        <p>Get request to https://enigmatic-crag-17408.herokuapp.com/recipe/--id of the recipe-- will bring the right recipe in JSON format</p>
        ...
        <p>PUT request to https://enigmatic-crag-17408.herokuapp.com/recipe/--id of the recipe-- will adjust the single recipe</p>
        Example: https://enigmatic-crag-17408.herokuapp.com/recipe/5ebfc2c7bfcc1718296cab17 will adjust 'Caponata pasta'
        <br/>
        <hr/>
        <h1>DELETE - Deleting a single recipe</h1>
        <p>DELETE request to https://enigmatic-crag-17408.herokuapp.com/recipe/--id of the recipe-- will delete the single recipe</p>
        Example: https://enigmatic-crag-17408.herokuapp.com/recipe/5ebfc2c7bfcc1718296cab17 will delete 'Caponata pasta'
        <br/>
        <hr/>
    </div>
